...
def topology():
    ...
    if 'ESPTR' in sys.argv[1]:
        ...
        r1.cmd('ip xfrm policy add dir in src 192.168.1.0/30 dst 192.168.0.1/30 tmpl src 10.0.0.2 dst 10.0.0.1 proto esp mode tunnel')
        r1.cmd('ip xfrm policy add dir fwd src 192.168.1.0/30 dst 192.168.0.1/30 tmpl src 10.0.0.2 dst 10.0.0.1 proto esp mode tunnel')
        r1.cmd('ip xfrm policy add dir out src 192.168.0.0/30 dst 192.168.1.1/30 tmpl src 10.0.0.1 dst 10.0.0.2 proto esp mode tunnel')
        r2.cmd('ip xfrm policy add dir in src 192.168.0.0/30 dst 192.168.1.1/30 tmpl src 10.0.0.1 dst 10.0.0.2 proto esp mode tunnel')
        r2.cmd('ip xfrm policy add dir fwd src 192.168.0.0/30 dst 192.168.1.1/30 tmpl src 10.0.0.1 dst 10.0.0.2 proto esp mode tunnel')
        r2.cmd('ip xfrm policy add dir out src 192.168.1.0/30 dst 192.168.0.1/30 tmpl src 10.0.0.2 dst 10.0.0.1 proto esp mode tunnel')
        ...
        r1.cmd('ip xfrm policy add dir in src 192.168.1.0/30 dst 192.168.0.0/30 tmpl src 10.0.0.2 dst 10.0.0.1 proto ah mode tunnel')
        r1.cmd('ip xfrm policy add dir fwd src 192.168.1.0/30 dst 192.168.0.0/30 tmpl src 10.0.0.2 dst 10.0.0.1 proto ah mode tunnel')
        r1.cmd('ip xfrm policy add dir out src 192.168.0.0/30 dst 192.168.1.0/30 tmpl src 10.0.0.1 dst 10.0.0.2 proto ah mode tunnel')
        r2.cmd('ip xfrm policy add dir in src 192.168.0.0/30 dst 192.168.1.0/30 tmpl src 10.0.0.1 dst 10.0.0.2 proto ah mode tunnel')
        r2.cmd('ip xfrm policy add dir fwd src 192.168.0.0/30 dst 192.168.1.0/30 tmpl src 10.0.0.1 dst 10.0.0.2 proto ah mode tunnel')
        r2.cmd('ip xfrm policy add dir out src 192.168.1.0/30 dst 192.168.0.0/30 tmpl src 10.0.0.2 dst 10.0.0.1 proto ah mode tunnel')
        ...
        r1.cmd('ip xfrm policy add dir in src 192.168.1.0/30 dst 192.168.0.0/30 tmpl src 10.0.0.2 dst 10.0.0.1 proto ah tmpl src 10.0.0.2 dst 10.0.0.1 proto esp mode tunnel')
        r1.cmd('ip xfrm policy add dir fwd src 192.168.1.0/30 dst 192.168.0.0/30 tmpl src 10.0.0.2 dst 10.0.0.1 proto ah tmpl src 10.0.0.2 dst 10.0.0.1 proto esp mode tunnel')
        r1.cmd('ip xfrm policy add dir out src 192.168.0.0/30 dst 192.168.1.0/30 tmpl src 10.0.0.1 dst 10.0.0.2 proto ah tmpl src 10.0.0.1 dst 10.0.0.2 proto esp mode tunnel')
        r2.cmd('ip xfrm policy add dir in src 192.168.0.0/30 dst 192.168.1.0/30 tmpl src 10.0.0.1 dst 10.0.0.2 proto ah tmpl src 10.0.0.1 dst 10.0.0.2 proto esp mode tunnel')
        r2.cmd('ip xfrm policy add dir fwd src 192.168.0.0/30 dst 192.168.1.0/30 tmpl src 10.0.0.1 dst 10.0.0.2 proto ah tmpl src 10.0.0.1 dst 10.0.0.2 proto esp mode tunnel')
        r2.cmd('ip xfrm policy add dir out src 192.168.1.0/30 dst 192.168.0.0/30 tmpl src 10.0.0.2 dst 10.0.0.1 proto ah tmpl src 10.0.0.2 dst 10.0.0.1 proto esp mode tunnel')
